...
@main_bp.route("/eventdate/<int:id>")
def event_date(id):
    ...
    url = url_for("main.event_date", id=id, _external=True)
    ...
    return render_template(
        ...
        canonical_url=url_for("main.event_date", id=id, _external=True),
...
@main_bp.route("/eventdate/<int:id>/ical")
