...
class UpdateApiKeyHandler(AbstractCommandHandler):
    def handle(self, cmd: commands.UpdateApiKeyCommand, uow: AbstractUnitOfWork):
        ...
        api_key.update(actor=cmd.actor, name=cmd.name)
